...
async function checkTrainingStatus(){
    try{
        ...
        document.getElementById("trainingStatus").innerHTML = data.message;
    } catch(err){
        document.getElementById("trainingStatus").innerHTML = "Status check failed: " + err;
    }
}
...
def run_web_app():
    ...
    # Always retrain fresh on every web launch, so old saved models
    # from a previous run are never reused as-is.
    start_web_training_once()
